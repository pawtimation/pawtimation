    ...
    <div className="space-y-5 max-w-3xl mx-auto">
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          className="px-4 py-2 border-2 border-teal-600 text-teal-700 rounded-lg hover:bg-teal-50 transition font-medium flex items-center gap-2"
        >
      ...
      {showShareToast && (
        <div className="fixed top-4 right-4 bg-teal-600 text-white px-6 py-3 rounded-lg shadow-lg z-50 flex items-center gap-2">
