      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
              ...
              <div className="space-y-5">
                <div className="flex gap-4">
                  <div className="flex-1 bg-white rounded-xl p-5 shadow-md border border-slate-100">
                    <div className="w-12 h-12 rounded-lg mb-4 flex items-center justify-center" style={{ backgroundColor: '#008080' }}>
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                      </svg>
                    </div>
                    <div className="h-2 bg-slate-200 rounded w-16 mb-3"></div>
                    <div className="h-6 rounded w-full" style={{ backgroundColor: '#008080' }}></div>
                  </div>
                ...
                <div className="bg-white rounded-xl p-5 shadow-md border border-slate-100">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <div className="flex gap-1.5">
                      <div className="w-2 h-2 rounded-full" style={{ backgroundColor: '#008080' }}></div>
                      <div className="w-2 h-2 rounded-full bg-slate-300"></div>
                      <div className="w-2 h-2 rounded-full bg-slate-200"></div>
                    </div>
                  </div>
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 p-3 rounded-lg border" style={{ backgroundColor: '#0080801A', borderColor: '#0080803D' }}>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs" style={{ color: '#008080' }}>30-min Walk</div>
                      </div>
                      <div className="px-3 py-1 text-white text-xs font-medium rounded-full flex-shrink-0" style={{ backgroundColor: '#008080' }}>
                        2:00 PM
                      </div>
                    </div>
        ...
        <section className="mb-32">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white border border-slate-200 rounded-xl p-8 hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 rounded-lg flex items-center justify-center mb-4" style={{ backgroundColor: '#0080801A' }}>
                <svg className="w-6 h-6" fill="none" stroke="#008080" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex items-start gap-3">
                    <svg className="w-6 h-6 mt-0.5" fill="none" stroke="#008080" viewBox="0 0 24 24">
                ...
                <a href="#screenshots" className="font-medium inline-flex items-center gap-2 hover:opacity-80 transition-opacity" style={{ color: '#008080' }}>
                  See how it works 
        ...
        <section id="screenshots" className="mb-32">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-slate-50 rounded h-48 mb-4 p-4 overflow-hidden">
                <div className="bg-white rounded shadow-sm p-3 mb-2">
                  <div className="flex justify-between items-center mb-2">
                    <div className="h-2 rounded w-20" style={{ backgroundColor: '#008080' }}></div>
                    <div className="h-2 bg-slate-300 rounded w-12"></div>
                  </div>
                  <div className="grid grid-cols-3 gap-2">
                    <div className="rounded p-2" style={{ backgroundColor: '#0080801A' }}>
                      <div className="h-4 rounded w-full mb-1" style={{ backgroundColor: '#0080804D' }}></div>
                      <div className="h-2 rounded w-2/3" style={{ backgroundColor: '#00808033' }}></div>
                    </div>
            ...
            <div className="bg-white border border-slate-200 rounded-lg p-4 hover:shadow-lg transition-shadow">
              <div className="bg-white rounded h-48 mb-4 p-3 flex flex-col border border-slate-100">
                <div className="flex items-center justify-between mb-3">
                  <div className="h-6 w-6 rounded-full" style={{ backgroundColor: '#008080' }}></div>
                ...
                <div className="flex-1 flex flex-col gap-2">
                  <div className="text-white rounded-lg p-2" style={{ backgroundColor: '#008080' }}>
            ...
            <div className="bg-white border border-slate-200 rounded-lg p-4 hover:shadow-lg transition-shadow">
              <div className="rounded h-48 mb-4 p-4" style={{ background: 'linear-gradient(to bottom right, #0080801A, #00808033)' }}>
                <div className="bg-white rounded-lg shadow-md p-3 mb-2">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="w-8 h-8 rounded-full" style={{ backgroundColor: '#0080804D' }}></div>
                    <div>
                  ...
                  <div className="border-t border-slate-200 pt-2">
                    ...
                    <div className="flex gap-2">
                      <div className="h-1.5 rounded w-12" style={{ backgroundColor: '#00808066' }}></div>
                      <div className="h-1.5 bg-slate-300 rounded w-16"></div>
                    </div>
                  </div>
                </div>
                <div className="flex gap-2">
                  <div className="flex-1 text-white rounded h-7" style={{ backgroundColor: '#008080' }}></div>
                  <div className="flex-1 bg-white rounded h-7" style={{ border: '2px solid #008080' }}></div>
                </div>
              </div>
        ...
        <section className="mb-32 -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 py-16 rounded-2xl" style={{ backgroundColor: '#0080801A' }}>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg p-6 shadow-md">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center text-white font-bold" style={{ backgroundColor: '#008080' }}>
                    R
                  </div>
                  <div>
