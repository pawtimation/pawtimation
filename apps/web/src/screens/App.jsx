...
import { ClientDogProfile } from './client/ClientDogProfile';
...
import { ComplianceSummary } from './legal/ComplianceSummary';
      ...
      <div className="flex-1">
        <div className={(isAdminRoute || isStaffRoute || isHomepage || isLegalOrSupport) ? '' : 'max-w-5xl mx-auto px-4 py-4 md:px-6 md:py-6'}>
          ...
          <Routes>
            ...
            <Route path="/legal/compliance-summary" element={<ComplianceSummary />} />
