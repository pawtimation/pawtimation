        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          ...
          >
            ...
            <div className="relative">
              <div className="flex items-center justify-between mb-2">
                ...
                <svg className="w-6 h-6 md:w-10 md:h-10 text-white/30" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="relative bg-white border border-gray-200 rounded-2xl p-4 md:p-6 shadow-sm hover:shadow-md transition-all">
            <div className="flex items-center justify-between mb-2">
              ...
              <svg className="w-6 h-6 md:w-10 md:h-10 opacity-40" style={{color: COLORS.teal}} fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="relative bg-white border border-gray-200 rounded-2xl p-4 md:p-6 shadow-sm hover:shadow-md transition-all">
            <div className="flex items-center justify-between mb-2">
              ...
              <svg className="w-6 h-6 md:w-10 md:h-10 opacity-40" style={{color: COLORS.mint}} fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="relative bg-white border border-gray-200 rounded-2xl p-4 md:p-6 shadow-sm hover:shadow-md transition-all">
            <div className="flex items-center justify-between mb-2">
              ...
              <svg className="w-6 h-6 md:w-10 md:h-10 opacity-40" style={{color: COLORS.tealLight}} fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          ...
          >
            <div className="flex items-center justify-between mb-2">
              ...
              <svg className="w-6 h-6 md:w-10 md:h-10 opacity-40" style={{color: COLORS.success}} fill="currentColor" viewBox="0 0 20 20">
