    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="px-4 md:px-10 py-4 md:py-6 space-y-4 md:space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-3xl md:text-5xl font-bold mb-1 leading-tight">{stats.todayJobs.total}</p>
              <p className="text-xs text-white/80 leading-normal">{stats.todayJobs.completed} completed · {stats.todayJobs.upcoming} upcoming</p>
            </div>
          </div>
          ...
          <div className="relative bg-white border border-gray-200 rounded-2xl p-4 md:p-6 shadow-sm hover:shadow-md transition-all">
            <div className="flex items-center justify-between mb-2">
              ...
              <svg className="w-8 h-8 md:w-10 md:h-10 opacity-40" style={{color: COLORS.teal}} fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd"/>
              </svg>
            </div>
            <p className="text-3xl md:text-5xl font-bold text-gray-900 mb-1 leading-tight">{stats.weekJobs.total}</p>
            <p className="text-xs leading-normal" style={{color: stats.weekJobs.change >= 0 ? COLORS.success : COLORS.error}}>
          ...
          <div className="relative bg-white border border-gray-200 rounded-2xl p-4 md:p-6 shadow-sm hover:shadow-md transition-all">
            <div className="flex items-center justify-between mb-2">
              ...
              <svg className="w-8 h-8 md:w-10 md:h-10 opacity-40" style={{color: COLORS.mint}} fill="currentColor" viewBox="0 0 20 20">
                <path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z"/>
              </svg>
            </div>
            <p className="text-3xl md:text-5xl font-bold text-gray-900 mb-1 leading-tight">{stats.activeClients}</p>
            <p className="text-xs text-gray-500 leading-normal">{stats.newClientsThisMonth} new this month</p>
          </div>
          ...
          <div className="relative bg-white border border-gray-200 rounded-2xl p-4 md:p-6 shadow-sm hover:shadow-md transition-all">
            <div className="flex items-center justify-between mb-2">
              ...
              <svg className="w-8 h-8 md:w-10 md:h-10 opacity-40" style={{color: COLORS.tealLight}} fill="currentColor" viewBox="0 0 20 20">
                <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z"/>
              </svg>
            </div>
            <p className="text-3xl md:text-5xl font-bold text-gray-900 mb-1 leading-tight">{stats.activeStaff.active}</p>
            <p className="text-xs text-gray-500 leading-normal">{stats.activeStaff.total} total staff</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <p className="text-xs md:text-sm font-medium text-gray-600 leading-tight">Revenue (Last 7 Days)</p>
              <svg className="w-8 h-8 md:w-10 md:h-10 opacity-40" style={{color: COLORS.success}} fill="currentColor" viewBox="0 0 20 20">
            ...
            <p className="text-3xl md:text-5xl font-bold text-gray-900 mb-1 leading-tight">{formatCurrency(stats.revenue7Days.totalCents)}</p>
            <p className="text-xs leading-normal" style={{color: stats.revenue7Days.change >= 0 ? COLORS.success : COLORS.error}}>
          ...
          <div className="relative rounded-2xl p-4 md:p-6 shadow-sm hover:shadow-md transition-all text-white" style={{background: `linear-gradient(to bottom right, ${COLORS.amber}, #FCD34D)`}}>
            <div className="flex items-center justify-between mb-2">
              <p className="text-xs md:text-sm font-medium text-white/90 leading-tight">Unpaid Invoices</p>
              <svg className="w-8 h-8 md:w-10 md:h-10 text-white/30" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10a2 2 0 00-2-2H4zm2 6a2 2 0 012-2h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4zm6 4a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd"/>
              </svg>
            </div>
            <p className="text-3xl md:text-5xl font-bold mb-1 leading-tight">{formatCurrency(stats.unpaidInvoices.totalCents)}</p>
            <p className="text-xs text-white/80 leading-normal">{stats.unpaidInvoices.count} invoice{stats.unpaidInvoices.count !== 1 ? 's' : ''}</p>
          </div>
          ...
          <div className="relative rounded-2xl p-4 md:p-6 shadow-sm hover:shadow-md transition-all text-white" style={{
            ...
            <div className="flex items-center justify-between mb-2">
              <p className="text-xs md:text-sm font-medium text-white/90 leading-tight">Overdue Invoices</p>
            ...
            <p className="text-3xl md:text-5xl font-bold mb-1 leading-tight">{formatCurrency(stats.overdueInvoices.totalCents)}</p>
            {stats.overdueInvoices.count > 0 ? (
              <p className="text-xs text-white/80 leading-normal">{stats.overdueInvoices.count} invoice{stats.overdueInvoices.count !== 1 ? 's' : ''}</p>
            ) : (
              <p className="text-xs text-white/80 leading-normal">All clear</p>
            )}
          </div>
          ...
          <div className="relative bg-white border border-gray-200 rounded-2xl p-4 md:p-6 shadow-sm hover:shadow-md transition-all">
            <div className="flex items-center justify-between mb-2">
              <p className="text-xs md:text-sm font-medium text-gray-600 leading-tight">Paid This Month</p>
              <svg className="w-8 h-8 md:w-10 md:h-10 opacity-40" style={{color: COLORS.success}} fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
              </svg>
            </div>
            <p className="text-3xl md:text-5xl font-bold text-gray-900 mb-1 leading-tight">{formatCurrency(stats.paidThisMonth.totalCents)}</p>
            <p className="text-xs text-gray-500 leading-normal">{stats.paidThisMonth.count} invoice{stats.paidThisMonth.count !== 1 ? 's' : ''}</p>
          </div>
